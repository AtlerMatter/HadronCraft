...
//	}
	...
	public Item getItemDropped(int par1, Random random, int par3){
		return Item.getItemFromBlock(HcBlocks.fissionReactorIdle);
	}
	...
	public static void updateBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord){
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, HcBlocks.fissionReactorActive);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, HcBlocks.fissionReactorIdle);
		}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ){
		if(world.isRemote){
			...
			player.openGui(MainRegistry.modInstance, MainRegistry.guiIdFissionReactor, world, x, y, z);
		}
		return true;
	}
